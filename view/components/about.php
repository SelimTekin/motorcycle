                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="about__feature__item">
                            <img src="../images/about/af-1.png" alt="">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="about__feature__item">
                            <img src="../images/about/af-2.png" alt="">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="about__feature__item">
                            <img src="../images/about/af-3.png" alt="">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="about__pic">
                        <img src="../images/about/about-pic.jpg" alt="">
                    </div>
                </div>
    ...
    <!-- Call Section Begin -->
    <section class="call spad set-bg" data-setbg="../images/about/call-bg.jpg">
        <div class="container">
            <div class="row">
    ...
    <!-- Counter Begin -->
    <div class="counter spad set-bg" data-setbg="../images/counter-bg.jpg">
        <div class="container">
            <div class="row">

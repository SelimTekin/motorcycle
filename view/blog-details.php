            ...
            <div class="row d-flex justify-content-center">
                <div class="col-lg-10">
                    <div class="blog__details__hero__text">
                        ...
                        <ul>
                            <li><img src="../images/blog/details/details-hero-avatar.png" alt=""> <span>By Evelyn Lane</span>
                            </li>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="blog__details__author">
                        <div class="blog__details__author__pic">
                            <img src="../images/blog/details/author.png" alt="">
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <a href="#" class="blog__details__btns__item set-bg"
                                            data-setbg="../images/blog/details/pre.jpg">
                                    ...
                                    <div class="col-lg-6">
                                        <a href="#" class="blog__details__btns__item set-bg"
                                            data-setbg="../images/blog/details/next.jpg">
                                            <h6>Promotional Advertising Specialty</h6>
                                            <ul>
                                                <li>By Don Townsend</li>
                                                <li>Dec 22, 2018</li>
                    ...
                    <div class="blog__details__comment">
                        ...
                        <div class="blog__details__comment__item reply__comment">
                            <div class="blog__details__comment__item__pic">
                                <img src="../images/blog/details/comment-2.png" alt="">
                            </div>
                            <div class="blog__details__comment__item__text">
                                <h6>Brandon Kelley</h6>
